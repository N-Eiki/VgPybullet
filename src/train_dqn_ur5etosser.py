...
def run_episode_dqn_learn_ur5etosser(episode):
    """Runs an episode."""
    global Q, memory, episode_totalrewards
...
def learn(Q, memory):
    ...
    max_next_q_values = Q(batch_next_state).detach().max(1)[0]
...
if __name__ == '__main__':
    ...
    for e in range(EPISODES):
        final_action = run_episode_dqn_learn_ur5etosser(e)
